...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SIL_Raspi.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SIL_Raspi.elf
...
DEFINES_STANDARD = -DMODEL=SIL_Raspi -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/SIL_Raspi_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/SIL_Raspi_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/SIL_Raspi_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
