 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun Jul 28 18:39:49 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_ADS1115_Out
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_ADS1115_Out_Outputs_wrapper(int16_T *y0,
			const real_T *xD,
			const uint8_T *chan, const int_T p_width0);
extern void sfcn_ADS1115_Out_Update_wrapper(int16_T *y0,
			real_T *xD,
			const uint8_T *chan, const int_T p_width0);
/*====================*
 * S-function methods *
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *chan = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    
    sfcn_ADS1115_Out_Outputs_wrapper(y0, xD, chan, p_width0);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    sfcn_ADS1115_Out_Update_wrapper(y0, xD, chan, p_width0);
