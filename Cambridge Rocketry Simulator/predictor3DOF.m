...
vel_n = vel(1); % [m/s] axial velocity
vel_a = vel(2); % [m/s] normal velocity
...
ii = 1;
while vel_y > epsilon % While velocity is larger than some value
    
    % Aerodynamic Force Calculations
    alpha_attack = atan2(vel_n, vel_a); % [rad] angle of attack (assuming no wind)
