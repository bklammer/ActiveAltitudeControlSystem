...
function varargout=rocketflightAIRBRAKE(varargin)
warning off
tic
INTAB1=varargin{1}{1};
INTAB2=varargin{1}{2};
...
RL=varargin{3}; %Launch rail length (m);
Ra=varargin{4}; %Launch rail angle(degrees) from vetical 0<Ra<90;
Rbearing=varargin{5}; %Launch rail bearing (degrees) from north 0<Rbearing<360;
...
[tt,z]=ascentcalcAIRBRAKE(ttspan,z0,YA0,PA0,RA0,INTAB1,INTAB2,INTAB3,INTAB4,Ar,RL,Ra,mu,RBL,G,label);
