...
PA0=varargin{4};    % Initial pitch axis angle
RA0=varargin{5};    % Initial roll axis angle
INTAB1=varargin{6}; % Thrust and mass properties
INTAB2=varargin{7}; % Drag coefficients
...
G=varargin{15};     % Universal gravitational constant
label=varargin{16}; % Let's you know if you're going ballistic
if nargin==16
    ig_delay=0;     
elseif nargin==17
    ig_delay=varargin{17}; % Ignition delay
end
...
[tt,z]=ode45(@blastoff6dof,ttspan,z0,options);
    ...
    function zd=blastoff6dof(tt,z)
        ...
        apogee = predictor(pos, vel, Cd, Cn, Xbar, Mi, I, Ar, temp, Pressure);
